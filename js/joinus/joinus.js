...
var data = [
  {
    itemTitle: ['高级开发工程师', '云产品研发中心', '北京', '2017-06-23'],
    descript: {
      duty: [
  ...
  {
    itemTitle: ['高级开发工程师', '云产品研发中心', '北京', '2017-08-25'],
    descript: {
      duty: [
  ...
  {
    itemTitle: ['高级开发工程师', '存储研发组', '北京', '2017-06-23'],
    descript: {
      duty: [
  ...
  {
    itemTitle: ['经理', '平台研发部', '北京', '2017-06-23'],
    descript: {
      duty: [
        '负责国美云平台系统部日常管理工作;',
  ...
  {
    itemTitle: ['架构师', '平台研发部', '北京', '2017-06-23'],
    descript: {
      duty: [
  ...
  {
    itemTitle: ['信息安全工程师', '云产品研发中心', '北京', '2017-06-23'],
    descript: {
      duty: [
  ...
  {
    itemTitle: ['架构师', '硬件设备管理部', '北京', '2017-06-23'],
    descript: {
      duty: [
  ...
  {
    itemTitle: ['架构师', '基础架构管理部', '北京', '2017-06-23'],
    descript: {
      duty: [
        '负责私有云平台的总体规划与架构设计工作',
        '负责云平台的稳定性和技术架构的持续优化',
  ...
  {
    itemTitle: ['高级产品经理', '产品部', '北京', '2017-06-23'],
    descript: {
      duty: [
  ...
  {
    itemTitle: ['架构师', '应用系统管理部', '北京', '2017-06-23'],
    descript: {
      duty: [
  ...
  {
    itemTitle: ['高级运维工程师（DBA）', '应用产品支持部', '北京', '2017-06-23'],
    descript: {
      duty: [
...
function loadHtml(data) {
  ...
  for(var j =0; j < digit; j++) {
    for(var i = 0; i< data.length; i++) {
      ...
      if(i >= j*10 && i < (j+1)*10) {
        content[j] += '<div class="job-item"><div class="job-item-title" data-toggle="collapse" data-target="#item'+ i +'"><p class="job-item-head">'+ data[i].itemTitle[0] +'</p><p class="job-item-head">'+ data[i].itemTitle[1] +'</p><p class="job-item-head">'+ data[i].itemTitle[2] +'</p><p class="job-item-head">'+ data[i].itemTitle[3] +' <span class="shrink"></span></p><hr style="margin: 0 20px;" /></div><div id="item'+ i +'" class="'+ ifDisplay +'"><div class="job-detail"><p>岗位职责</p><ul>'+
        LiOneList 
        +'</ul><p>任职资格</p><ul>'+
        LiTowList
        +'</ul> <div class="contentUs"><img src="./images/joinus/3.png" alt=""><span style="margin: 0 20px 0 10px;">简历直达：<a href="mailto:suyu-kg@gome.com.cn">suyu-kg@gome.com.cn</a></span><span>关注微信：aliker</span></div> </div><hr style="margin: 0 20px;" /></div></div>';
      }
    }
  }
}
